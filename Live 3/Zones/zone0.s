...
HitBox_List0
	START_HITBOX
	DEF_HITBOX ACTIVE,0,0,SCREEN_X,SCREEN_Y,RIGHT_MB,menu_return
	DEF_HITBOX ACTIVE,22,219,594,4,LEFT_MB,click_barre
	DEF_HITBOX ACTIVE,62,227,24,14,LEFT_MB,dzign_selector
	DEF_HITBOX ACTIVE,207,226,8,21,LEFT_MB,set_global_volume
	DEF_HITBOX ACTIVE,170,227,24,14,LEFT_MB,change_HP
	DEF_HITBOX ACTIVE,289,227,35,14,LEFT_MB,goto_menu
	DEF_HITBOX ACTIVE,434,227,35,14,LEFT_MB,goto_help
	DEF_HITBOX ACTIVE,512,227,24,14,LEFT_MB,go_left
	DEF_HITBOX ACTIVE,564,227,24,14,LEFT_MB,go_right
	END_HITBOX

ShortCut_List0
	START_SHORTCUT
	DEF_SHORTCUT ACTIVE,$41,menu_return
	DEF_SHORTCUT ACTIVE,$22,dzign_selector
	DEF_SHORTCUT ACTIVE,$29,goto_menu
	DEF_SHORTCUT ACTIVE,$21,change_HP
	DEF_SHORTCUT ACTIVE,$4c,set_global_volume_plus
	DEF_SHORTCUT ACTIVE,$4d,set_global_volume_minus
	DEF_SHORTCUT ACTIVE,$32,exit_live
	DEF_SHORTCUT ACTIVE,$4f,go_left
	DEF_SHORTCUT ACTIVE,$4e,go_right
	DEF_SHORTCUT ACTIVE,$5f,goto_help
	DEF_SHORTCUT ACTIVE,$25,goto_help
	DEF_SHORTCUT ACTIVE,$45,exit_live
	END_SHORTCUT

ShortCut_List1
	START_SHORTCUT
	DEF_SHORTCUT ACTIVE,$4f,sc_mouse_left
	DEF_SHORTCUT ACTIVE,$4e,sc_mouse_right
	DEF_SHORTCUT ACTIVE,$4c,sc_mouse_up
	DEF_SHORTCUT ACTIVE,$4d,sc_mouse_down
	DEF_SHORTCUT ACTIVE,$64,sc_mouse_click_left
	END_SHORTCUT
...
Render_Barre
	WAIT_BLITTER					efface la barre complète
...
.ok0	move.l Board_Bottom(pc),a0
	...
	move.l #594,d1				calcul la largeur de la
...
Barre_Lechage0
	...
	bclr d2,SCREEN_WIDTH*SCREEN_DEPTH(a1)			couleur 14
	bset d2,SCREEN_WIDTH*SCREEN_DEPTH+SCREEN_WIDTH(a1)
	bset d2,SCREEN_WIDTH*SCREEN_DEPTH+SCREEN_WIDTH*2(a1)
	bset d2,SCREEN_WIDTH*SCREEN_DEPTH+SCREEN_WIDTH*3(a1)

	add.w d1,d0
	subq.w #1,d0
	move.w d0,d2
	lsr.w #3,d2
	lea (a0,d2.w),a1			pointe le dernier octet
	move.w d0,d2
	and.w #$7,d2
	not.w d2
	bset d2,(a1)						couleur 13
	bclr d2,SCREEN_WIDTH(a1)
	bset d2,SCREEN_WIDTH*2(a1)
	bset d2,SCREEN_WIDTH*3(a1)

	bclr d2,SCREEN_WIDTH*SCREEN_DEPTH(a1)			couleur 12
	bclr d2,SCREEN_WIDTH*SCREEN_DEPTH+SCREEN_WIDTH(a1)
	bset d2,SCREEN_WIDTH*SCREEN_DEPTH+SCREEN_WIDTH*2(a1)
	bset d2,SCREEN_WIDTH*SCREEN_DEPTH+SCREEN_WIDTH*3(a1)
click_barre_rts
	rts
...
.ok3	move.w d1,bs_CoordY(a0)
	add.w d0,d0
	IFNE ZIK
	move.w volume_table(pc,d0.w),mt_percent_to_reach-data_base(a5)
	ENDC
...
volume_table
	dc.w 100,93,87,81,75,68,62,53,50,43,37,31,25,18,12,6
Bob_volume_back
