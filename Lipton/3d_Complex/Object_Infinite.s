...
;	dc.w $467,$B9A,$58B,$A89,$47A,$978,$369,$A68
	dc.w $312,$B9A,$58B,$A89,$47A,$978,$369,$A68

my_ExtraInit
	clr.w dir-data_base(a5)
	rts

my_ExtraJump
	subq.w #4,PosY(a0)			deplacement de l'objet
	tst.w dir-my_object(a0)
	beq.s gauche_middle
	cmp.w #-170,PosY(a0)
	sle exit_flag-data_base(a5)
	bra.s nouille
gauche_middle
	cmp.w #SCREEN_HEIGHT/2,PosY(a0)
	bgt.s nouille
