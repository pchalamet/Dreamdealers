...
Live_EntryPoint
	...
	dc.b "$VER:  Live v2.7 - Release 4 (??/Jan/94) - (c)1993-1994 DreamDealers",0
	even
skip_copyright
	lea data_base(pc),a5
...
Load_Module
	...
	move.l d0,Module_Size2-data_base(a5)
	bmi .load_mod_error
...
.load_mod_error
	...
	clr.l Module_Size2-data_base(a5)
	clr.l Module_Type-data_base(a5)
.no_mod_mem
...
Request_Disk
	dc.w 10,10
	dc.w (63*SCREEN_DEPTH<<6)|((130+15)>>4)
	dc.w SCREEN_WIDTH-((130+15)>>3)&$fffe
	dc.l Bob_Request_Disk-Request_Disk
Bob_Request_Disk
	incbin "Disk.PAK"

Request_Memory
	dc.w 10,10
	dc.w (40*SCREEN_DEPTH<<6)|((115+15)>>4)
	dc.w SCREEN_WIDTH-((115+15)>>3)&$fffe
	dc.l Bob_Request_Memory-Request_Memory
Bob_Request_Memory
	incbin "Memory.PAK"
