...
Live_Entry_Point
	...
	move.l #Live_Req_Title,(a0)+		frq_Title
	move.l #DOS_Module_Path,(a0)+		frq_Dir
	move.l #DOS_Module_Name,4(a0)		frq_PathName
...
Load_Module
	...
	move.l #DOS_Module_Name,d1		essait d'obtenir un Lock
	...
	move.l #DOS_Module_Name,d1		ouvre le fichier en lecture
...
DOS_Module_Path		dcb.b 130+1

DOS_Module_Name		dc.b "LIVE:music/mod.1.2.3.jazz",0
			dcb.b 130+30+2-(*-DOS_Module_Name),0
